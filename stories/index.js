...
storiesOf("Button", module)
  ...
  .add("Erorr", () => <Error message="Could not delete appointment." onClose={action("onClose")}/>)
  .add("Form-Edit", () => <Form student="Noah Thomlison" interviewer="1" interviewers={interviewers} onSave={action("onSave")}  onCancel={action("onCancel")} />)
  .add("Form-Create", () => 
  <Form 
  interviewers={interviewers} 
